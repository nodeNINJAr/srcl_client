...
import { MdKeyboardArrowDown } from "react-icons/md"; // Replace Ant Design icons with `react-icons`
import { HomeOutlined } from "@ant-design/icons";
export const menuItems = [
  {
    key: "home",
    label: <Link title="Sustainable for future" to="/">Home</Link>,
    icon: <HomeOutlined />, // Replaced `HomeOutlined` with `MdHome`
  },
  {
    key: "about-us",
    label: (
  ...
  },
  {
    key: "resources",
    label: (
      <Link to={"/resources/survey-equipment"}> <span className="flex justify-between items-center gap-1">
      Resources
    </span></Link>
    )
  },
